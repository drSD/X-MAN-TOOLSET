...
@lexer::header {
package uk.ac.man.xman.dsl.parser.antlr.internal;
...
@parser::members {
    ...
    public InternalConditionDSLParser(TokenStream input, ConditionDSLGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected ConditionDSLGrammarAccess getGrammarAccess() {
...
ruleExpression returns [EObject current=null] 
    ...
    { 
        newCompositeNode(grammarAccess.getExpressionAccess().getCompositeExpressionParserRuleCall()); 
    }
    this_CompositeExpression_0=ruleCompositeExpression
    { 
        $current = $this_CompositeExpression_0.current; 
        afterParserOrEnumRuleCall();
    }
...
entryRuleCompositeExpression returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getCompositeExpressionRule()); }
	 iv_ruleCompositeExpression=ruleCompositeExpression 
	 { $current=$iv_ruleCompositeExpression.current; } 
	 EOF 
;

// Rule CompositeExpression
ruleCompositeExpression returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    { 
        newCompositeNode(grammarAccess.getCompositeExpressionAccess().getAtomicExpressionParserRuleCall_0()); 
    }
...
((((
    {
        $current = forceCreateModelElementAndSet(
            grammarAccess.getCompositeExpressionAccess().getANDLeftAction_1_0_0_0(),
            $current);
    }
)(
(
		{ 
	        newCompositeNode(grammarAccess.getCompositeExpressionAccess().getOpANDOperatorParserRuleCall_1_0_0_1_0()); 
	    }
		lv_op_2_0=ruleANDOperator		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getCompositeExpressionRule());
	        }
       		set(
       			$current, 
       			"op",
    ...
    {
        $current = forceCreateModelElementAndSet(
            grammarAccess.getCompositeExpressionAccess().getORLeftAction_1_0_1_0(),
            $current);
    }
)(
(
		{ 
	        newCompositeNode(grammarAccess.getCompositeExpressionAccess().getOpOROperatorParserRuleCall_1_0_1_1_0()); 
	    }
		lv_op_4_0=ruleOROperator		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getCompositeExpressionRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getCompositeExpressionAccess().getRightAtomicExpressionParserRuleCall_1_1_0()); 
	    }
		lv_right_5_0=ruleAtomicExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getCompositeExpressionRule());
	        }
       		set(
...
(((
    {
        $current = forceCreateModelElement(
            grammarAccess.getAtomicExpressionAccess().getAtomicExpressionAction_0_0(),
            $current);
    }
)((	otherlv_1='(' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getAtomicExpressionAccess().getLeftParenthesisKeyword_0_1_0_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getAtomicExpressionAccess().getExprExpressionParserRuleCall_0_1_0_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getAtomicExpressionAccess().getRightParenthesisKeyword_0_1_0_2());
    }
)
    |((
(
		lv_name_4_0=RULE_ID
		{
			newLeafNode(lv_name_4_0, grammarAccess.getAtomicExpressionAccess().getNameIDTerminalRuleCall_0_1_1_0_0()); 
		}
		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getAtomicExpressionAccess().getOpComparisonOperatorEnumRuleCall_0_1_1_1_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getAtomicExpressionAccess().getValueValueParserRuleCall_0_1_1_2_0()); 
	    }
    ...
    |
    { 
        newCompositeNode(grammarAccess.getAtomicExpressionAccess().getConstantParserRuleCall_1()); 
    }
...
(    this_INT_0=RULE_INT    {
    ...
    |
    { 
        newCompositeNode(grammarAccess.getValueAccess().getFLOATParserRuleCall_1()); 
    }
    ...
    |
    { 
        newCompositeNode(grammarAccess.getValueAccess().getBOOLEAN_CONSTANTParserRuleCall_3()); 
    }
    this_BOOLEAN_CONSTANT_3=ruleBOOLEAN_CONSTANT    {
		$current.merge(this_BOOLEAN_CONSTANT_3);
    }
...
(
		lv_value_0_0=	'.' 
    {
        newLeafNode(lv_value_0_0, grammarAccess.getConstantAccess().getValueFullStopKeyword_0());
    }
...
ruleANDOperator returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getANDOperatorAccess().getAmpersandAmpersandKeyword()); 
    }
...
ruleOROperator returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getOROperatorAccess().getVerticalLineVerticalLineKeyword()); 
    }
...
entryRuleBOOLEAN_CONSTANT returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getBOOLEAN_CONSTANTRule()); } 
	 iv_ruleBOOLEAN_CONSTANT=ruleBOOLEAN_CONSTANT 
	 { $current=$iv_ruleBOOLEAN_CONSTANT.current.getText(); }  
	 EOF 
;

// Rule BOOLEAN_CONSTANT
ruleBOOLEAN_CONSTANT returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getBOOLEAN_CONSTANTAccess().getTrueKeyword_0()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getBOOLEAN_CONSTANTAccess().getFalseKeyword_1()); 
    }
)
    ;
...
((	enumLiteral_0='==' 
    ...
    |(	enumLiteral_1='!=' 
	{
        $current = grammarAccess.getComparisonOperatorAccess().getNEQEnumLiteralDeclaration_1().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_1, grammarAccess.getComparisonOperatorAccess().getNEQEnumLiteralDeclaration_1()); 
    }
)
    |(	enumLiteral_2='<' 
	{
    ...
    |(	enumLiteral_4='>' 
	{
        ...
        newLeafNode(enumLiteral_4, grammarAccess.getComparisonOperatorAccess().getGTEnumLiteralDeclaration_4()); 
    }
)
    |(	enumLiteral_5='>=' 
	{
        $current = grammarAccess.getComparisonOperatorAccess().getGTEEnumLiteralDeclaration_5().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_5, grammarAccess.getComparisonOperatorAccess().getGTEEnumLiteralDeclaration_5()); 
    }
));
